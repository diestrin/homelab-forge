...
Phase 3 CLIs via HM: `kubectl`, `helm`, `vault`, `claude-code` (unfree allowed via flake `allowUnfreePredicate`), `codex` (OpenAI Codex CLI, overlaid from `nixpkgs-unstable`).
